...
INSERT INTO "new_Settings" ("aiMode", "aiModel", "aiProvider", "aiSharedFields", "anonymizeBeforeSend", "apiKeyIv", "createdAt", "currency", "dataRetentionYears", "encryptedApiKey", "id", "salonEmail", "salonName", "salonPhone", "sessionIdleTimeoutMinutes", "timezone", "updatedAt") SELECT "aiMode", "aiModel", "aiProvider", "aiSharedFields", "anonymizeBeforeSend", "apiKeyIv", "createdAt", "currency", "dataRetentionYears", "encryptedApiKey", "id", "salonEmail", "salonName", "salonPhone", "sessionIdleTimeoutMinutes", "timezone", "updatedAt" FROM "Settings";
DROP TABLE "Settings";
