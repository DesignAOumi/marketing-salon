...
INSERT INTO "new_Settings" ("aiMode", "aiModel", "aiProvider", "aiSharedFields", "anonymizeBeforeSend", "apiKeyIv", "createdAt", "currency", "dataRetentionYears", "encryptedApiKey", "id", "onboardingStep", "salonEmail", "salonName", "salonPhone", "sessionIdleTimeoutMinutes", "setupCompletedAt", "timezone", "updatedAt") SELECT "aiMode", "aiModel", "aiProvider", "aiSharedFields", "anonymizeBeforeSend", "apiKeyIv", "createdAt", "currency", "dataRetentionYears", "encryptedApiKey", "id", "onboardingStep", "salonEmail", "salonName", "salonPhone", "sessionIdleTimeoutMinutes", "setupCompletedAt", "timezone", "updatedAt" FROM "Settings";
DROP TABLE "Settings";
